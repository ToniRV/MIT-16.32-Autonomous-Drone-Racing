...
Quad.X_arm  = patch('xdata', Quad.X_armX, ...
                    'ydata', Quad.X_armY, ...
                    'zdata', Quad.X_armZ, ...
                    'facealpha', .9, 'facecolor', 'b');
Quad.Y_arm  = patch('xdata', Quad.Y_armX, ...
                    'ydata', Quad.Y_armY, ...
                    'zdata', Quad.Y_armZ, ...
                    'facealpha', .9, 'facecolor', 'b');
Quad.Motor1 = patch('xdata', Quad.Motor1X, ...
                    'ydata', Quad.Motor1Y, ...
                    'zdata', Quad.Motor1Z, ...
                    'facealpha',.3,'facecolor','g');
Quad.Motor2 = patch('xdata', Quad.Motor2X, ...
                    'ydata', Quad.Motor2Y, ...
                    'zdata', Quad.Motor2Z, ...
                    'facealpha',.3,'facecolor','k');
Quad.Motor3 = patch('xdata', Quad.Motor3X, ...
                    'ydata', Quad.Motor3Y, ...
                    'zdata', Quad.Motor3Z, ...
                    'facealpha',.3,'facecolor','k');
Quad.Motor4 = patch('xdata', Quad.Motor4X, ...
                    'ydata', Quad.Motor4Y, ...
                    'zdata', Quad.Motor4Z, ...
