...
[Quad.Xtemp,Quad.Ytemp,Quad.Ztemp]=rotateBFtoGF(Quad.X_armX,Quad.X_armY,Quad.X_armZ,Quad.State.phi,Quad.State.theta,Quad.State.psi);
set(Quad.X_arm,'xdata',Quad.Xtemp+Quad.State.X,'ydata',-(Quad.Ytemp+Quad.State.Y),'zdata',-(Quad.Ztemp+Quad.State.Z))
