...
t_min = [t0, t1-t_tol, t2-t_tol, tf];
t_max = [t0, t1+t_tol, t2+t_tol, tf];
...
for p = 1:3
    ...
    % Fixed final time for all phases
...
%-------------------------------------------------------------------------%
setup.name                           = 'minCurve';
setup.functions.continuous           = @minCurveContinuous;
setup.functions.endpoint             = @minCurveEndpoint;
setup.bounds                         = bounds;
setup.guess                          = guess;
